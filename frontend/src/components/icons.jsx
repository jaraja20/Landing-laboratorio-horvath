...
export const IconAward = (p) => (
  <S {...p}><circle cx="12" cy="8" r="6"/><path d="M15.477 12.89 17 22l-5-3-5 3 1.523-9.11"/></S>
);
...
export const IconSnowflake = (p) => (
  <S {...p}>
    ...
    <path d="M4.2 7 4 10m.2-3 3 .8M19.8 7l.2 3m-.2-3-3 .8"/>
    <path d="M19.8 17l.2-3m-.2 3-3-.8M4.2 17 4 14m.2 3 3-.8"/>
  </S>
);
